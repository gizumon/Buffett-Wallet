...
class CreateEvaluationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('evaluations', function (Blueprint $table) {
            ...
            $table->integer('buy_id')->nullable()->comment('FK:Buys ID');
            $table->integer('sale_id')->nullable()->comment('FK:Sales ID');
            ...
            $table->date('delete_flag')->default(0)->comment('Next check date');
            $table->date('profit')->default(0)->comment('Next check date');
            //外部キー制約
